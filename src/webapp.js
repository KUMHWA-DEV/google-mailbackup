...
function getDashboard() {
  ...
  return {
    ...
    importRun: (function () { try { var st = importStatus_(); var cur = st.cursor || importCursor_() || {}; return { state: st.state || 'idle', message: st.message || '', cursor: cur, progress: importProgress_(cur), repair: importRepairInfo_(cur) }; } catch (e) { return { state: 'idle' }; } })(),
